...
export default function About() {
  return <div className={style.wrapper}>
    ...
    <p>While working on this app, I practiced React, component-based architecture, routing, API requests, and state management.</p>
    <h2>A little about course:</h2>
    <p>This project is part of the RS School React training program, where I’m improving my frontend skills through hands-on practice and real-world-style tasks.</p>

    <div className={style.logo}><Icon name="logo" className={style.logo}></Icon></div>
    <p>My project mentor: <a href="https://github.com/max0n4ik" title="GitHub" target="_blank" className={style.link}>Maksim Gorohov</a>.</p>
    <p>Course: <a href="https://rs.school/courses/reactjs"
      title="RS School react course"
      target="_blank" className={style.link}>RS&nbsp;School React&nbsp;Course</a></p>
  </div>
}